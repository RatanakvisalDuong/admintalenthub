                    ...
                    return (
                        ...
                        >
                            ...
                            {item.showBadge && (
                                <>
                                    {isLoading ? (
                                        <span className={`w-5 h-5 rounded-full flex items-center justify-center ${isActive
                                        ...
                                        <span className={`min-w-[20px] h-5 px-1.5 rounded-full text-xs font-bold flex items-center justify-center ${isActive
                                                ? "bg-white text-[#5086ed]"
