...
interface PendingEndorserApplicationClientProps {
    initialApplications: EndorserApplication[];
    session: Session;
}

export default function PendingEndorserApplicationClient({
    initialApplications,
    session
}: PendingEndorserApplicationClientProps) {
    const [applications, setApplications] = useState<EndorserApplication[]>(initialApplications);
